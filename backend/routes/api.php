...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::put('courses/{id}', [CourseController::class, 'update']); // Actualizar curso
    Route::delete('courses/{id}', [CourseController::class, 'destroy']); // Eliminar curso
});
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/users/{userId}/assign-role', [
        RoleController::class,
        'assignRole'
    ]);
    Route::post('/users/{userId}/remove-role', [
        RoleController::class,
        'removeRole'
    ]);
});
